# Week 3 Homework – Killercoda Linux Fundamentals
...
This repository contains screenshots of **Killercoda Linux Fundamentals Week 3 homework exercises (Lessons 1–10)**.  
The goal is to log into [Killercoda Linux Fundamentals](https://killercoda.com/pawelpiwosz/course/linuxFundamentals) with a GitHub account, complete all lessons, and upload proof of completion here.
...
- Pawel Piwosz – [Killercoda Linux Fundamentals Course](https://killercoda.com/pawelpiwosz/course/linuxFundamentals)  
...
If you encounter issues while working on Killercoda labs:

1. **Refresh the Environment** – Sometimes the terminal may freeze; restarting the lab helps.  
2. **Check Command Syntax** – Typos in Linux commands are a common cause of errors. Use `man <command>` for help.  
3. **Networking Issues** – If `ping` or `curl` fails, verify you are in the correct container environment.  
4. **Re-run Exercises** – If screenshots are missing or corrupted, redo the exercise and capture again.  
